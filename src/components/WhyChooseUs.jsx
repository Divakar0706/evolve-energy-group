...
export default function WhyChooseUs() {
  ...
  return (
    <section className="py-24 px-6 md:px-12 lg:px-20 bg-slate-950 text-center relative overflow-hidden" id="about">
      {/* Background Decor */}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {points.map((item, index) => (
            <motion.div
              ...
              className="group relative bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-xl hover:bg-slate-800/80 transition-all duration-300 overflow-hidden text-left"
            >
              ...
              <div className={`w-16 h-16 rounded-xl flex items-center justify-center mb-6 bg-gradient-to-br ${item.color} text-white shadow-lg shadow-black/50 group-hover:-translate-y-1 transition-transform duration-300`}>
                {item.icon}
              </div>
