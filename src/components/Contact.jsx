        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-stretch">
          ...
          >
            <div className="flex items-center gap-4 sm:gap-6 group">
              <div className="shrink-0 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-primary-50 rounded-2xl flex items-center justify-center text-primary-600 text-xl sm:text-2xl group-hover:bg-primary-600 group-hover:text-white transition-colors duration-300 shadow-sm">
                <FiMapPin />
              </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="bg-slate-900 p-6 sm:p-8 lg:p-10 rounded-3xl shadow-2xl relative overflow-hidden"
          >
            {/* Background Glow */}
            ...
            <form onSubmit={handleSubmit} className="relative z-10 space-y-4 sm:space-y-6">
              ...
              <button 
                ...
                className="w-full bg-primary-600 text-white font-bold px-4 sm:px-6 py-3 sm:py-4 rounded-xl hover:bg-primary-500 disabled:bg-slate-700 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(34,197,94,0.5)] transform disabled:hover:-translate-y-0 hover:-translate-y-1 text-sm sm:text-base flex justify-center items-center gap-2"
              >
